<template>
  <div class="apply-container">
    <van-tabs class="navContainer" v-model="active" @click="onRoute(navs[fIndex].path, fwl.id, fIndex)" :lazy-render="false" :animated="true">
      <template v-for="(item, index) in tab">
        <van-tab :key="index" ref="nav" class="nav">
          <template #title>
            <div
              class="nav-item"
